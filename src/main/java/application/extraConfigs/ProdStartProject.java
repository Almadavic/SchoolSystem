...
//@Configuration               DESATIVADO PARA NÃO CRIAR O MESMO PRINCIPAL TODA VEZ QUE A APLICAÇÃO SUBIR || SÓ ATIVEI NA PRIMEIRA VEZ PARA CRIAR O REGISTRO NA TABELA.
@Profile(value = {"prod"})
public class ProdStartProject implements CommandLineRunner { // Classe chamada apenas quando a aplicação estiver em produção.
