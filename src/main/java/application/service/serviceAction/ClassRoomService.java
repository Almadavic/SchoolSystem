...
import application.service.businessRule.createClass.CreateClassCheck;
import application.service.businessRule.setTeacher.SetTeacherCheck;
import application.service.businessRule.updateGrade.TeacherAllowed;
import application.service.businessRule.updateGrade.UpdateGradesCheck;
...
public class ClassRoomService {
    ...
    private void teacherAllowed(ClassRoom classRoom, Principal user) { //  Verifica se o teacher está permitido a fazer algo.
        ...
        if (userEntity instanceof Teacher) {
            TeacherAllowed valid = new TeacherAllowed();
            valid.validation(null, classRoom, user);
        }
    }
